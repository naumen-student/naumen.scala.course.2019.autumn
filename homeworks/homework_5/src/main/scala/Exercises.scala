object Exercises {
  ...
  case class Shelter[+T <: Animal](animals: List[T]) {
    def +[B >: T <: Animal](newAnimal: B): Shelter[B] = Shelter[B](animals = newAnimal :: animals)

    def ++[B >: T <: Animal](newAnimals: Shelter[B]): Shelter[B] = Shelter[B](animals = newAnimals.animals ::: animals)
